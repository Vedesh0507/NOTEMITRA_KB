    ...
    <div className="min-h-screen">
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            {/* Contact Person 1 */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 sm:p-6 lg:p-8 rounded-xl border border-blue-200">
              <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-blue-600 text-white rounded-full mx-auto mb-4 sm:mb-6">
                <User className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-4 sm:mb-6">M. Pavan Vedesh</h3>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-2 sm:gap-3">
                  <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 mt-1 flex-shrink-0" />
                  <a href="mailto:pavanmanepalli521@gmail.com" className="text-sm sm:text-base text-gray-700 hover:text-blue-600 transition break-all">
                    pavanmanepalli521@gmail.com
                  </a>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Phone className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 flex-shrink-0" />
                  <a href="tel:+919391781748" className="text-sm sm:text-base text-gray-700 hover:text-blue-600 transition">
                    +91 93917 81748
                  </a>
                </div>
              </div>
            ...
            {/* Contact Person 2 */}
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-5 sm:p-6 lg:p-8 rounded-xl border border-purple-200">
              <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-purple-600 text-white rounded-full mx-auto mb-4 sm:mb-6">
                <User className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-4 sm:mb-6">D. Mohan Gupta</h3>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-2 sm:gap-3">
                  <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-purple-600 mt-1 flex-shrink-0" />
                  <a href="mailto:mohangupta16@gmail.com" className="text-sm sm:text-base text-gray-700 hover:text-purple-600 transition break-all">
                    mohangupta16@gmail.com
                  </a>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Phone className="h-4 w-4 sm:h-5 sm:w-5 text-purple-600 flex-shrink-0" />
                  <a href="tel:+918790965198" className="text-sm sm:text-base text-gray-700 hover:text-purple-600 transition">
                    +91 87909 65198
                  </a>
                </div>
              </div>
